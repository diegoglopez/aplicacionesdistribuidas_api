...
//    @Column(unique = true, nullable = false)
    ...
    private ArrayList<Pregunta> preguntasDiarias=new ArrayList<>();
    ...
    public ArrayList<Pregunta> getPreguntasDiarias() {
        return preguntasDiarias;
    }

    public void setPreguntasDiarias(ArrayList<Pregunta> preguntasDiarias) {
        this.preguntasDiarias = preguntasDiarias;
    }

    public void agregarPreguntaDiaria(Pregunta pregunta){
        pregunta.setRespondida(false);
        this.preguntasDiarias.add(pregunta);
    }
}
