...
//    CrudT crud;
    ...
    private ArrayList<EntidadInterface> noticias;
    private ArrayList<EntidadInterface> preguntas;
    private ArrayList<PreguntaDiaria> preguntaDiarias;
    ...
    private void iniciacion() {
        ...
        this.preguntaDiarias=new ArrayList<>();
...
//        grupo.addUser(user);
    ...
    public boolean restarPuntosByusuario(jsonData data) {
        return sumarPuntosByusuario(data);
    }
}
